...
const WHATS_NEW = {
    ...
    '1.7.0': [
        { date: 'July 2026 · 1.7.0 — security release' },
        ...
        { title: 'Only admins can stop a stream', desc: 'the Stop button in Server Activity was shown to everyone, though the server had always refused anyone but an admin. The button now matches the rule, instead of failing when pressed.' },
...
const VERSION_MODAL_SECTIONS = [
    {
        title: "1.7.0: ready to be reachable from outside your network",
