...
| **Versioning** | Independent. Commissary reset to `1.0.0` at the fork point, took the name at **2.0.0**, and is now **2.3.7**. Upstream's numbering (3.x) is unrelated, and the in-app update check points here, not there. |
...
```bash
docker pull ghcr.io/thymrman/commissary:2.3.7
```
