...
# Re-exported: this module is where music-side callers look for anything about
# where a file goes, but the probe itself is shared with the video Libraries and
