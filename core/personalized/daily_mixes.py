    ...
    with database._get_connection() as conn:
        ...
        for row in cur.fetchall():
            ...
            track = {
                ...
                # FORK DIVERGENCE from upstream, which multiplies by 1000.
                # Upstream reads `tracks.duration` as SECONDS; this fork stores
                # MILLISECONDS (205520 = 3:25, and core/artists/quality.py uses the
                # column directly as duration_ms). Multiplying here rendered every
                # track in a mix as roughly 48 hours long.
