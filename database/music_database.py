...
class MusicDatabase:
    ...
    def _initialize_database(self):
        ...
        try:
            ...
            # The Soulseek chat feature was removed; shed its archive table
            # so an upgraded database doesn't carry dead rows forever.
            cursor.execute("DROP TABLE IF EXISTS chat_room_messages")
